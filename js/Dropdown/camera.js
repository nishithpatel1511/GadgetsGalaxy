...
$(function () {
  $.ajax({
    url: "https://nishithpatel1511.github.io/GadgetsGalaxy/js/Dropdown/json/camera.json",
    dataType: 'JSON',
    success: function (data) {
      ...
      $.each(data, function (key, value) {
        ...
        if (window.innerWidth < 992) {
          if ((l % 4) == 1) {
            r++;
            $('#megamenu-camera').append('<div class="row megamenu-row" id="mrow-' + r + '"></div>');
            l = 1;
          }
        ...
        //five cols
          ...
          if((temp%5==2)&(n==2)){
            ...
            $(row).append('<div class="megamenu-col-5" id="' + r + '-mcol-00"></div>');
            n--;
          }
